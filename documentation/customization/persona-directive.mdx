...
- Choose this by clicking on the AI Control menu in the top right corner, then click Default AI, and scroll down to select which persona custom directive to apply.
