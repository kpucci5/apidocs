---
title: "Channel Settings for Managers"
--- 


Channel settings for **Managers** allow them to manage **Personas, members, and various settings**.
