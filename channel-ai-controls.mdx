...
<img
  className="block dark:hidden"
  src="/images/cac-3.png"
  alt="Fallback Suggestion"
/>
...
**Voice Responses** - Generates an audio version of your AI's text response.
